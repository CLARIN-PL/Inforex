...
CREATE TABLE `reports` (
  ...
  CONSTRAINT `reports_ibfk_11` FOREIGN KEY (`format_id`) REFERENCES `reports_formats` (`id`),
  CONSTRAINT `reports_ibfk_12` FOREIGN KEY (`format_id`) REFERENCES `reports_formats` (`id`),
  CONSTRAINT `reports_ibfk_13` FOREIGN KEY (`format_id`) REFERENCES `reports_formats` (`id`),
  CONSTRAINT `reports_ibfk_14` FOREIGN KEY (`format_id`) REFERENCES `reports_formats` (`id`),
