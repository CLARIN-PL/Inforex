...
CREATE TABLE `activities` (
  ...
  KEY `activities_user_datetime_idx` (`user_id`,`datetime`),
  KEY `activities_user_type_datetime_idx` (`user_id`,`activity_type_id`,`datetime`),
  KEY `activities_datetime_user_idx` (`datetime`,`user_id`),
  KEY `activities_anonymous_datetime_ip_idx` (`user_id`,`datetime`,`ip_id`)
...
CREATE TABLE `exports` (
  ...
  `status` enum('new','process','done','error','canceled') CHARACTER SET utf8 NOT NULL DEFAULT 'new',
  `description` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `tasks_reports` (
  ...
  `status` enum('new','process','done','error','canceled') CHARACTER SET utf8 NOT NULL,
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
