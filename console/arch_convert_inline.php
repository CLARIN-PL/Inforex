...
/* 
 * ---
 * Converts content of reports in the database from in-line to stand-off style of annotation.
 * The annotations are stored in a separate table in the database.
 *
 * Wywołanie:
