                                        ...
                                        {else}
                                            {foreach from=$corporaflags item=corporaflag}
                                                <span
                                                    ...
                                                    title="{$corporaflag.name}: {if $corporaflag.id}{$corporaflag.name}{else}NIE GOTOWY{/if}">
                                                       <img src="gfx/flag_{if $corporaflag.id}{$corporaflag.id}{else}-1{/if}.png" style="padding-top: 1px"/>
