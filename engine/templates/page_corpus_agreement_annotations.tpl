                                    ...
                                    <tr>
                                        {if array_key_exists($ank, $agreement.only_a)}
                                            {if $comparision_mode == "distinct_types"}
                                                <td class="user_a {$an.annotation_name}"><em>{$an.annotation_name} </em>[{$an.type_id}
                                                    ]
                                                </td>
                                            {else}
                                        ...
                                        {if array_key_exists($ank, $agreement.a_and_b)}
                                            {if $comparision_mode == "distinct_types"}
                                                <td class="{$an.annotation_name}">
                                                    <em>{$an.annotation_name} </em>[{$an.type_id}]
                                                </td>
                                            {else}
                                                <td>{$agreement.annotations_a[$ank].id}
                                                    <br/>{$agreement.annotations_b[$ank].id}</td>
                                                <td>[{$an.from},{$an.to}]</td>
                                                <td><em>{$an.text}</em></td>
                                                <td>
                                                    {if $agreement.annotations_a[$ank].lemma != $agreement.annotations_b[$ank].lemma}
                                                        <span style="color: red">
                                        {if $agreement.annotations_a[$ank].lemma}{$agreement.annotations_a[$ank].lemma}{else}
                                            <i>n/a</i>
                                        {/if}
                                                <br/>
                                                {if $agreement.annotations_b[$ank].lemma}{$agreement.annotations_b[$ank].lemma}{else}
                                                    <i>n/a</i>
                                                {/if}
                                    </span>
                                                    {else}
                                        ...
                                        {if array_key_exists($ank, $agreement.only_b)}
                                            {if $comparision_mode == "distinct_types"}
                                                <td class="user_b {$an.annotation_name}"><em>{$an.annotation_name} </em>[{$an.type_id}
                                                    ]
                                                </td>
                                            {else}
                            ...
                            <div class="panel-body" style="">
                                ...
                                <div style="vertical-align: middle; line-height: 20px">
                                    {foreach from=$subcorpora item=subcorpus}
                                        <label><input type="checkbox" name="subcorpus_ids[]"
                            ...
                            <div class="panel-body" style="">
                                ...
                                <select name="comparision_mode">
                                    {foreach from=$comparision_modes key=k item=mode}
                                        <option value="{$k}"
                                                {if $k==$comparision_mode}selected="selected"{/if}>{$mode}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
                                ...
                                {else}
                                    <table class="tablesorter" cellspacing="1" style="width: 100%; margin-top: 6px;">
                                        ...
                                        <tr{if "final" == $annotator_a_id} class="user_a"{elseif "final" == $annotator_b_id} class="user_b"{/if}
                                            ...
                                            <td style="text-align: center;"><input type="radio" name="annotator_a_id"
                                                                                   value="final"
                                                                                   {if "final" == $annotator_a_id}checked="checked"{/if}/>
                                            </td>
                                            <td style="text-align: center;"><input type="radio" name="annotator_b_id"
                                                                                   value="final"
                                                                                   {if "final" == $annotator_b_id}checked="checked"{/if}/>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                {foreach from=$pcs key=category item=data}
                                    <tr{if $category=="all"} class="highlight"{/if}>
                                        <td><a href="#" class="filter_by_category_name"
                                               title="Highlight rows containing annotations of given category">{$category}</a>
                                        </td>
