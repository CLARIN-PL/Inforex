...
{if $corpus.public || $user}
    <div class="row">
        ...
        <div class="col-md-2 scrollingWrapper panel-group" id="accordion">
            ...
            <div class="panel panel-info">
                ...
                <div id="collapseActive" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingActive">
                    <div id="filter_menu_active" class="panel-body scrollingAccordion">
            ...
            <div class="panel panel-info">
                ...
                <div id="collapseAvailable" class="panel-collapse collapse{if $filter_order|@count==0} in{/if}" role="tabpanel" aria-labelledby="headingAvailable">
                    <div id="filter_menu" class="panel-body scrollingAccordion">
            ...
            <div class="panel panel-info" id="selection_menu">
                ...
                <div id="collapseBatch" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingBatch">
                    <div class="panel-body scrollingAccordion">
