<div class="dialog" data-role="dialog"  id="ajax_access_error_modal">
...
<div class="dialog w-75" data-role="dialog" id="ajax_error_modal">
    <div class="dialog-title">An error has occurred</div>
