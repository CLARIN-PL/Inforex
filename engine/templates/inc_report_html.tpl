...
<div class="ui-widget ui-widget-content ui-corner-all" style="margin: 5px">			
	<div class="ui-widget ui-widget-header ui-helper-clearfix ui-corner-all">Document with in-line annotations:</div>
	<div style="padding: 5px;">
		<code class="html" style="white-space: pre-wrap"><br/>{$content_edit|escape:"html"}</code>
	</div>
</div>
