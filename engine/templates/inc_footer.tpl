{* Zamknięcie szablonu strony. Szablon rozpoczynający: inc_header *}
		...
		<div id="footer">
			...
			Developed by <a href="http://czuk.eu" title="Michała Marcińczuka home page">Michał Marcińczuk</a>, <a href="http://www.facebook.com/djkotu">Jan Kocoń</a>, Marcin Ptak, 2009&ndash;2012;</br>
