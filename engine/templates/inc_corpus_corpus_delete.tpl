...
<button type="button" class="delete_corpora_button btn btn-danger" style = "margin-bottom: 20px;" data-toggle="modal" data-target="#deleteCorpus">Delete corpora</button>
