...
{if $filter_type == "text" }   
	<div class="filter_box">
		{if $search}
			<a class="cancel" href="index.php?page=corpus_documents&amp;corpus={$corpus.id}&amp;search="><small class="toggle">cancel</small>
		{else}
		...
		<div id="filter_search" need_order_and_results_limit="1" class="options" {if !$search}style="display: none"{/if}>
			<form action="index.php?page=corpus_documents">
...
{if $filter_type == "base"}
    <div class="filter_box">
        {if $base}
            <a class="cancel" href="index.php?page=corpus_documents&amp;corpus={$corpus.id}&amp;base=&amp;base_show_found_sentences=0"><small class="toggle">cancel</small>
        {else}
...
{if $filter_type == "annotation_value"}
    <div class="filter_box">
    	{if $annotation_value}
			<a class="cancel" href="index.php?page=corpus_documents&amp;corpus={$corpus.id}&amp;annotation_value="><small class="toggle">cancel</small>
		{else}
