...
<div class="panel administration-content-panel administration-users-panel">
	...
	<div class="panel-body scrollingWrapper">
		...
		<div class="administration-toolbar">
			<div id="searchbar">
				<form class="search-form">
					<div class="form-group">
						<div class="input-group administration-search">
							<span class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span>
							<input class="form-control" name="search" placeholder="Search users" autocomplete="off" autofocus="autofocus" type="text">
						</div>
				</div>
				</form>
			</div>
...
{if "admin"|has_role}
	...
	<div id="toolbar"></div>
	<div class="scrolling administration-table-wrapper">
		<table id="usersTable" class="table table-striped administration-table" cellspacing="1"
			   data-toggle="table"
			   data-search="true"
...
<div class="modal fade settingsModal administration-form-modal administration-user-modal" id="create_user_modal" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title"><i class="fa fa-user-plus" aria-hidden="true"></i> Add new user</h4>
			</div>
...
<div class="modal fade settingsModal administration-form-modal administration-user-modal" id="edit_user_modal" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title"><i class="fa fa-user-circle" aria-hidden="true"></i> Edit user</h4>
			</div>
			<div class="modal-body">
