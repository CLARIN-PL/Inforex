...
{block name=body}
    ...
    <div id="editUser" class="dialog" data-role="dialog">
        <form id="edit_user_form" data-role="validator"
              data-on-submit="onEditUserSubmit"
              action="javascript:" data-interactive-check="true">
            ...
            <div class="dialog-content">
                <div class="bg-white p-2">
                    ...
                    <div class="row mb-2">
                        <label class="cell-sm-4">Login</label>
                        <div class="cell-sm-8">
                            <input id="edit_user_login" type="text" name="login"
                                   data-validate="required custom=checkLoginWithIdExists">
                            <span class="invalid_feedback">
                                This filed is required or user with this login exists.
                            </span>
                        </div>
            ...
            <div class="dialog-actions">
                <button class="button js-dialog-close">Cancel</button>
                <button type="submit" class="button primary confirm_edit_user">Save</button>
            </div>
        </form>
    </div>
{/block}
