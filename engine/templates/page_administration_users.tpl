...
{block name=body}
    <div class="row border-bottom bd-lightGra m-3">
        <div class="cell-md-4 d-flex flex-align-center">
            <h5 class="dashboard-section-title text-left text-left w-100"><span class="mif-users"></span> Users</h5>
        </div>
    ...
    <div class="m-3">
                ...
                <div class="bg-white p-2">
                    <form id="create_user_form" action="index.php?page=user_admin" method="post">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="cell-sm-8">
                                <input id="create_user_password" name="password" type="password" data-validate="required minlength=6"">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="class" id="createNewUser" data-role="dialog">
            ...
            <div class="bg-white p-2">
                <form id="edit_user_form" action="index.php?page=user_admin" method="post">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="cell-sm-8">
                            <input id="edit_user_password" name="password" type="password" data-validate="required minlength=6"">
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="">
            <div class="bg-white p-4">
                <div class="d-flex flex-wrap flex-nowrap-lg flex-align-center flex-justify-center flex-justify-start-lg mb-2">
                    ...
                    <button class="image-button primary ml-2" onclick="Metro.dialog.open('#createNewUser')">
