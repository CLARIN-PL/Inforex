<div id="frame_elements">	
	...
	<div class="elements" id="elements_sections">
		...
		<div id="elem-0">
			<p>Szkielet dokumentu składa się ze znaczników <span class="tag">text</span>, <span class="tag">body</span> i <span class="tag">pb</span>.</p>			
		...
		<div id="elem-4">[<a href="#" id="element_closer"><span class="tag">closer</span></a>] &mdash; zakończenie listu<br/>
			<br/>
			<b>Znaczniki zagnieżdżone:</b>
			<ul class="elements">
