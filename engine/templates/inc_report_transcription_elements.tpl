		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="padding: 5px">
				...
				<ul class="nav nav-tabs">
					...
					<li><a data-toggle="tab" href="#elem-2">[p]</a></li>
					<li><a data-toggle="tab" href="#elem-3">[ornament]</a></li>
				...
				<div class="tab-content scrolling">
					...
					<div id="elem-8" class="tab-pane fade">
					...
					<div id="elem-3" class="tab-pane fade">
						<span class="tag">ornament</span> &mdash; linia rozdzielająca tekst,
						<ul class="elements">
					...
					<div id="elem-4" class="tab-pane fade">
						[<span class="tag">closer</span>] &mdash; zakończenie listu
						<ul class="elements">
					...
					<div id="elem-5" class="tab-pane fade">
						[<a href="#" id="element_ps"><span class="tag">ps</span></a>] &mdash; sekcja post scriptum,<br/>
						<br/>
						<b>Znaczniki zagnieżdżone:</b>
						<ul class="elements">
					...
					<div id="elem-6" class="tab-pane fade">
