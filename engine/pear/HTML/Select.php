...
class HTML_Select extends HTML_Common
{
    ...
    function loadDbResult(&$result, $textCol=null, $valueCol=null, $values=null)
    {
        ...
        $fetchMode = ($textCol && $valueCol) ? MDB2_FETCHMODE_ASSOC : MDB2_FETCHMODE_DEFAULT;
