...
function smarty_modifier_format_annotations($string)
{
    ...
    $string = preg_replace('/<an#(\d+):([^:]+):(\d+):(\d+):\'(.*?)\'>/u', "<span id='an$1' class='annotation_set_$3 $2' groupid='$3' subgroupid='$4' lemma='$5' title='an#$1:$2'>", $string);
	$string = preg_replace('/<an#(\d+):([^:]+):(\d+):(\d+)>/u', "<span id='an$1' class='annotation_set_$3 $2' groupid='$3' subgroupid='$4' title='an#$1:$2'>", $string);
	$string = preg_replace('/<an#(\d+):([^:]+):(\d+)>/u', "<span id='an$1' class='annotation_set_$3 $2' groupid='$3' title='an#$1:$2'>", $string);
