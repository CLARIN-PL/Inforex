...
def clear_database(db_dict, corpus):
    ...
    sql = []
    sql.append("TRUNCATE TABLE reports_limited_access ")
    sql.append("TRUNCATE TABLE corpus_perspective_roles ")
    sql.append("TRUNCATE TABLE users_corpus_roles ")
    sql.append("TRUNCATE TABLE users_roles ")
    sql.append("TRUNCATE TABLE user_activities ")
    sql.append("TRUNCATE TABLE activities ")
    sql.append("TRUNCATE TABLE activity_types ")
    sql.append("DELETE FROM corpora " + add_where(corpus, 'id'))
    sql.append("TRUNCATE TABLE annotation_types_attributes_enum ")
    sql.append("TRUNCATE TABLE ips ")
    sql.append("TRUNCATE TABLE ccl_viewer ")
    sql.append("TRUNCATE TABLE reports_users_selection ")
    sql.append("TRUNCATE TABLE annotation_types_shortlist")
