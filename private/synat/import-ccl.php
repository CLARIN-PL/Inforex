...
class ImportCCL{
	...
	function __construct(){
		...
		$this->opt->addParameter(new ClioptParameter("read_mode", "r", "read_mode", "read mode"));
		$this->opt->addParameter(new ClioptParameter("import_mode", "m", "import_mode", "import mode"));
		$this->opt->addParameter(new ClioptParameter("input", "i", "input", "input path"));
		$this->opt->addParameter(new ClioptParameter("annotation", "a", "annotation", "annotation regex"));
		$this->opt->addParameter(new ClioptParameter("debug_level", "d", "debug_level", "debug_level"));
